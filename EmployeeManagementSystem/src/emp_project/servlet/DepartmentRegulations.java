...
@WebServlet("/DepartmentRegulations")
public class DepartmentRegulations extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public DepartmentRegulations() 
    {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
        {
				...
				int DepartmentId=Integer.parseInt(dept_Id);
				...
				out.println("</tr>");  
		                PreparedStatement statement=Login_db.getPreparedStatement("select * from regulations where Department_Id="+DepartmentId);
